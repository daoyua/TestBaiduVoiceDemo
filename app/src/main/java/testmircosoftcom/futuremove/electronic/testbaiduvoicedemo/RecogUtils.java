...
import testmircosoftcom.futuremove.electronic.testbaiduvoicedemo.record.OfflineRecogParams;
...
public class RecogUtils {
     ...
     */
    protected static boolean enableOffline =true;
    public static void initRecog(Context context) {
